...
export default function SearchButton ({ ariaLabelledby, searchBtnRef }) {
  ...
  return (
    <button onClick={handleClick} className='fm-c-btn fm-c-btn--search govuk-body-s' {...ariaLabelledby ? { 'aria-labelledby': ariaLabelledby } : {}} aria-expanded={activePanel === 'SEARCH'} {...activePanel === 'SEARCH' ? { style: { display: 'none' } } : {}} ref={searchBtnRef}>
