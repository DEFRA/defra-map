...
export default function HelpButton ({ helpBtnRef }) {
  ...
  const button = () => {
    return (
      <button onClick={handleClick} className='fm-c-btn fm-c-btn--help' ref={helpBtnRef} aria-expanded={false} {...isMobile ? { 'aria-labelledby': `${id}-help-label` } : {}} {...activePanel === 'HELP' ? { style: { display: 'none' } } : {}}>
