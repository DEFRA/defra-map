    ...
    <div className='fm-o-viewport-controls'>
      ...
      {hasDrawCapability ? (
        <div className='fm-o-viewport-controls__group' {...mode === 'frame' ? { style: { display: 'none' } } : {}}>
          ...
          <Tooltip id={`${id}-delete-label`} position='below' cssModifier='delete' text='Delete'>
            <button onClick={handleSquareClick} className='fm-c-btn fm-c-btn--edit' aria-labelledby={`${id}-delete-label`}>
              <svg aria-hidden='true' width='20' height='20' viewBox='0 0 20 20' fillRule='evenodd'>
