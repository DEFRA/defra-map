...
export default function Location ({ ariaLabelledby }) {
  ...
  return (
    <button onClick={handleOnClick} className='fm-c-btn fm-c-btn--location' aria-labelledby={ariaLabelledby} aria-controls={`${id}-viewport`}>
      <svg aria-hidden='true' focusable='false' width='20' height='20' viewBox='0 0 20 20' fillRule='evenodd'><g fill='none' stroke='currentColor' strokeWidth='2'><circle cx='10' cy='10' r='6' /><path d='M10 4V1m0 18v-3m6-6h3M1 10h3' strokeLinecap='butt' /></g><circle cx='10' cy='10' r='3' fill='currentColor' /></svg>
    </button>
  )
}
