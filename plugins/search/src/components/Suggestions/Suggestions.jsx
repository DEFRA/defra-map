...
export const Suggestions = ({ id, appState, pluginState, handleSuggestionClick }) => {
  return (
    <ul
      ...
      className="am-c-search-suggestions"
    ...
    >
      {pluginState.suggestions.map((suggestion, i) => (
        <li
          ...
          className="am-c-search-suggestions__item"
          role="option"
        ...
        >
          <span className="am-c-search-suggestions__label" dangerouslySetInnerHTML={{ __html: suggestion.marked }} />
        </li>
      ))}
    </ul>
  )
