...
import { useTargetMarker } from '../../hooks/useTargetMarkerAPI'
import { useConfig } from '../../store/configContext'

// SVG paths keyed by marker state
const paths = {
...
export const TargetMarker = () => {
  const { id } = useConfig()
  const { markerRef, targetMarker } = useTargetMarker()
  const { isVisible, isPinnedToMap, state } = targetMarker
